...
type (
	...
	UseCaseHttp interface {
		GoogleLogin(res http.ResponseWriter, req *http.Request)
		GoogleCallback(res http.ResponseWriter, req *http.Request)
	}
)
