...
const (
	UploadService_GetAttachmentsByType_FullMethodName     = "/upload.v1.UploadService/GetAttachmentsByType"
	UploadService_GetAttachmentsByOptional_FullMethodName = "/upload.v1.UploadService/GetAttachmentsByOptional"
	UploadService_GetAvatarUser_FullMethodName            = "/upload.v1.UploadService/GetAvatarUser"
)
