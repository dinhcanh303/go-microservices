...
func prepareApp(ctx context.Context, cancel context.CancelFunc,
	cfg *config.Config,
	...
	a.NotiPub.Configure(
		publisher.ExChangeName("comment-noti-exchange"),
		publisher.BindingKey("comment-noti-routing-key"),
		publisher.MessageTypeName("comment-noti"),
	)
	return cleanup
}
